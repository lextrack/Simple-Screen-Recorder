...
namespace Simple_Screen_Recorder.ScreenRecorderWin
{
    public partial class MergeVideoAudioForm : Form
    {
        ...
        public void BtnMergeAll_Click(object sender, EventArgs e)
        {
            ...
            conversionProcess.StartInfo.Arguments = $"/c {RecorderScreenMainWindow.ResourcePath} -i " + txtVideoPath.Text + " -i " + txtAudioDesk.Text + " -c:v copy -c:a aac -b:a 320k OutputFiles/" + outputFileName + " & exit /b";
